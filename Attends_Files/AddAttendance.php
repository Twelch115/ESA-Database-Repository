...
$sql = "INSERT INTO attends(mission_name, astronaut_id) VALUES ('$AttName', $AttId)"; # create query to remove data from table at given id
...
$new_no_missions = $result['no_missions'] + 1; #set $new_no_missions as result plus one
...
$new_no_crew = $results['crew_size'] + 1; #set $new_no_crew as results plus one

...
<title> Remove a mission </title> <!-- Sets Page title -->
<link rel="icon" href="../Images/Rockets.jpg"> <!-- creates icon -->
</head> <!-- closes header tag -->
 
<body> <!-- opens body tag -->
<p> Remove a mission from the database </p> 
<a href = ../index.html> Cancel Removal <a> <br> <br> <!-- links back to the index page -->
<form action = "RemoveMission.php" method = "post"> <!-- starts the form, sets the action on submission and the method used -->
<div class="mb-3"> <!-- opens DIV -->
    <label for="type" class="form-label">Name of mission to be removed:</label> <br> <!-- sets the description label -->
    <select name="MissName"> <!-- sets name of selection box -->
	<?php
...
<input type = "submit" name = "MissSubmit" value = "Submit removal"> <!-- sets the form submission box -->
</form>	 <!-- ends the form -->	
</body>
</html>
